        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content" id="eg">
                <form class="layui-form" method="get" action="/admin/config/save">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">销售公告时间</label>
                        <div class="layui-input-block">
                            <div class="layui-inline">
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        <input type="text" class="layui-input" id="test15" placeholder="yyyy-MM-dd HH:mm:ss" name="sell" value="{{ $data->sell }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div>
                                <img src="{{ $data->img }}" alt="" id="show" style="width: 20%;margin-top: 1%">
