...
@if($data->firstTrial == session('admin') || $data->finalTrial == session('admin'))
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <img src="{{ $data->img->idCardfront }}" alt="身份证正面" style="width: 100%" title="idCardfront">
        </div>
        <div class="swiper-slide">
    ...
    var mySwiper = new Swiper('.swiper-container', {
        ...
        on:{
            slideChangeTransitionStart: function(){
               var title        = mySwiper.slides.eq(this.activeIndex).find('img').attr('alt');
               var filedTitle   = mySwiper.slides.eq(this.activeIndex).find('img').attr('title');
