                        ...
                        <div class="ibox">
                            ...
                            <div class="" style="margin-top: 5%" >
                                ...
                                <ul class="layui-nav ul-border" style="background-color: white">
                                    <li class="layui-nav-item <?php if($keyword['status'] == 0)echo 'layui-this'?>"><a href="/admin/index?status=0" class="index-font-weight <?php if($keyword['status'] == 0){echo 'index-active';}else{echo 'index-font-color';}?>">待初审</a></li>
                                    ...
                                    <li class="layui-nav-item <?php if($keyword['status'] == 2)echo 'layui-this'?>"><a href="/admin/index?status=2" class="index-font-weight <?php if($keyword['status'] == 2){echo 'index-active';}else{echo 'index-font-color';}?>">初审通过</a></li>
                                    <li class="layui-nav-item <?php if($keyword['status'] == 4)echo 'layui-this'?>"><a href="/admin/index?status=4" class="index-font-weight <?php if($keyword['status'] == 4){echo 'index-active';}else{echo 'index-font-color';}?>">初审不通过</a></li>
                                    ...
                                    <li class="layui-nav-item <?php if($keyword['status'] == 7)echo 'layui-this'?>"><a href="/admin/index?status=7" class="index-font-weight <?php if($keyword['status'] == 7){echo 'index-active';}else{echo 'index-font-color';}?>">复审不通过</a></li>
                                    <li class="layui-nav-item <?php if($keyword['status'] == 5)echo 'layui-this'?>"><a href="/admin/index?status=5" class="index-font-weight <?php if($keyword['status'] == 5){echo 'index-active';}else{echo 'index-font-color';}?>">复审通过</a></li>
                                </ul>
