...
$adminInfo = \App\Model\Admin::where('id',session('admin'))->first();
...
<div class="wrapper wrapper-content">
    @if($data->status == 1)
        ...
        @endif
        <button class="layui-btn layui-btn-primary layui-btn-radius" onclick="location.href='/admin/index?status={{ $data->status == 6 ? 0 :  $data->status}}'">返回</button>
    <div class="row">
        <div class="col-sm-3">
                ...
                <div class="ibox-content mailbox-content">
                    <div class="file-manager">
                        <table class="layui-table" style="width: 180%!important;">
                            ...
                            <tr>
                                <td>是否带未成年子女</td>
                                <td>{{ $data->hasChild == "" ? "" : $data->hasChild }}</td>
                            </tr>
                    ...
                    <div class="mail-body">
                        ...
                        <div class="file-box">
                            <div class="file img-div-p">
                                ...
                                <div class="image">
                                    <img alt="image" class="img-responsive  img-div-center" src="{{ $data->img->idCardfront }}" data-hash="idCardfront">
                                </div>
                        ...
                        <div class="file-box">
                            <div class="file img-div-p">
                                ...
                                <div class="image">
                                    <img alt="image" class="img-responsive  img-div-center" src="{{ $data->img->idCardback }}" data-hash="idCardback">
                                </div>
                                <div class="file-name">
                                    身份证反面
                                </div>
                        ...
                        <div class="file-box">
                            <div class="file img-div-p">
                                ...
                                <div class="image">
                                    <img alt="image" class="img-responsive  img-div-center" src="{{ $data->img->accountBook }}" data-hash="accountBook">
                                </div>
                                <div class="file-name">
                                    户口本首页
                                </div>
                        ...
                        <div class="file-box">
                            <div class="file img-div-p">
                                ...
                                <div class="image">
                                    <img alt="image" class="img-responsive  img-div-center" src="{{ $data->img->accountBookmain }}" data-hash="accountBookmain">
                                </div>
                                <div class="file-name">
                                    户口本主页
                                </div>
                        ...
                        <div class="file-box">
                            <div class="file img-div-p">
                                ...
                                <div class="image">
                                    <img alt="image" class="img-responsive  img-div-center" src="{{ $data->img->accountBookpersonal }}" data-hash="accountBookpersonal">
                                </div>
                                <div class="file-name">
                                    户口本个人页
                                </div>
                        ...
                        @if($data->img->death)
                            <div class="file-box">
                                <div class="file img-div-p">
                                    ...
                                    <div class="image">
                                        <img alt="image" class="img-responsive  img-div-center" src="{{ $data->img->death }}" data-hash="death">
                                    </div>
                                    <div class="file-name">
                                        死亡证明
                                    </div>
                        ...
                        @if($data->img->marry)
                            <div class="file-box">
                                <div class="file img-div-p">
                                    ...
                                    <div class="image">
                                        <img alt="image" class="img-responsive  img-div-center" src="{{ $data->img->marry }}" data-hash="marry">
                                    </div>
                                    <div class="file-name">
                                        结婚证
                                    </div>
                            ...
                            @foreach($data->img->other_img as $key=>$value)
                                <div class="file-box">
                                    <div class="file img-div-p" >
                                        ...
                                        <div class="image" >
                                            <img alt="image" class="img-responsive  img-div-center-other" src="{{ $value['idCardfront'] }}" data-hash="idCardfront-{{ $data->other[$key]['idCard'] }}">
                                        </div>
                                        <div class="file-name">
                                            身份证正面
                                        </div>
                                ...
                                <div class="file-box">
                                    <div class="file img-div-p">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive  img-div-center-other" src="{{ $value['idCardback'] }}" data-hash="idCardback-{{ $data->other[$key]['idCard'] }}">
                                        </div>
                                        <div class="file-name">
                                            身份证背面
                                        </div>
                                ...
                                <div class="file-box">
                                    <div class="file img-div-p">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive  img-div-center-other" src="{{ $value['accountBook'] }}" data-hash="accountBook-{{ $data->other[$key]['idCard'] }}">
                                        </div>
                                        <div class="file-name">
                                            户口本首页
                                        </div>
                                ...
                                <div class="file-box">
                                    <div class="file img-div-p">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive  img-div-center-other" src="{{ $value['accountBookmain'] }}" data-hash="accountBookmain-{{ $data->other[$key]['idCard'] }}">
                                        </div>
                                        <div class="file-name">
                                            户口本主页
                                        </div>
                                ...
                                <div class="file-box">
                                    <div class="file img-div-p">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive  img-div-center-other" src="{{ $value['accountBookpersonal'] }}" data-hash="accountBookpersonal-{{ $data->other[$key]['idCard'] }}">
                                        </div>
                                        <div class="file-name">
                                            户口本个人页
                                        </div>
