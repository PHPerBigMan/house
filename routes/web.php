...
Route::get('/admin/allData', "DataController@allData");
...
Route::get('/admin/demoIndex', function () {
    return view('Back.Demo.index');
});
...
/*2.0版本*/
Route::group(['prefix'=>'admin','namespace'=>'Back2','middleware'=>'admin'],function(){
    Route::any('/sale', "SaleController@index");
    Route::any('/saleData/{id}', "SaleController@saleData");
});
