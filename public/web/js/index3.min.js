...
var hidebg=function(){
	...
	for (var i = 0; i < 5; i++) {
	        ...
	        var src=$(".buyerbox").find(".buyimg"+(1+i)).attr("src");
	        console.log(alt);
	        console.log(src);
	...
	if($(".buyerbox").find(".boxmarry").length>0){
	        ...
	        var src=$(".buyerbox").find("#imgfilemarryimg").attr("src");
	        if(alt==src||src==undefined){
				$(".btn").removeClass("btnok");return;
			}else{
	...
	if($(".buyerbox").find(".diebox").length>0){
	        ...
	        var src=$(".buyerbox").find("#imgfiledieimg").attr("src");
	        if(alt==src||src==undefined){
				$(".btn").removeClass("btnok");return;
			}else{
	...
	if($(".buyerbox").find(".lihunbox").length>0){
				...
				for (var i = 0; i < lihunbox.length; i++) {
					if(!$(".lihunbox").find(".show_img").eq(i).hasClass("inputconkong")){
						...
						var src=$(".lihunbox").find(".show_img").eq(i).attr("src");
						console.log(alt)
						if(alt==src||src==undefined){
									$(".btn").removeClass("btnok");
									return;
	...
	if($(".page3").find(".childs").length>0){
		...
		for (var i = 0; i < buyothersbox.length; i++) {
	        ...
	        var src=$(".childs").find(".child_img_box_child").eq(i).find(".haschild"+(1+i)).attr("src");
	        console.log(alt)
	        console.log(src)
	        if(alt==src||src==undefined){
				$(".btn").removeClass("btnok");
	...
	if($(".page3").find(".buyothers").length>0){
		...
		for (var i = 0; i < buyothersbox.length; i++) {
			...
			for (var k = 0; k < 5; k++) {
			        ...
			        var src=$(".buyothers").find(".buyothersbox").eq(i).find(".buyimg"+(1+k)).attr("src");
			        if(alt==src||src==undefined){
						$(".btn").removeClass("btnok");
						return;
					}else{
...
if(havehouse=='是'){
	...
	for (var i = 0; i < hzhousebox.length; i++) {
		if(!$(".hzhousebox").find(".show_img").eq(i).hasClass("inputconkong")){
			...
			var src=$(".hzhousebox").find(".show_img").eq(i).attr("src");
			if(alt==src||src==undefined){
					   	$(".btn").removeClass("btnok");
						return;
			}else{
...
if($(".lastinfo").find('.trustpeople').length>0){  
	...
	for (var i = 0; i < trustpeople.length; i++) {
		if(!$(".trustpeople").find(".show_img").eq(i).hasClass("inputconkong")){
			...
			var src=$(".trustpeople").find(".show_img").eq(i).attr("src");
			if(alt==src||src==undefined){
						$(".btn").removeClass("btnok");
						return;
			}else{
	...
	if($(".lastinfo").find(".linanbox").length>0){
		...
		for (var i = 0; i < linanbox.length; i++) {
			if(!$(".linanbox").find(".show_img").eq(i).hasClass("inputconkong")){
				...
				var src=$(".linanbox").find(".show_img").eq(i).attr("src");
				if(alt==src||src==undefined){
							$(".btn").removeClass("btnok");
							return;
				}else{
	...
	for (var i = 0; i < zijinbox.length; i++) {
		if(!$(".zijinbox").find(".show_img").eq(i).hasClass("inputconkong")){
			...
			var src=$(".zijinbox").find(".show_img").eq(i).attr("src");
			if(alt==src||src==undefined){
						$(".btn").removeClass("btnok");
						return;
			}else{
	...
	if($(".lastinfo").find(".security").length>0){
		...
		for (var i = 0; i < security.length; i++) {
			if(!$(".security").find(".show_img").eq(i).hasClass("inputconkong")){
				...
				var src=$(".security").find(".show_img").eq(i).attr("src");
				if(alt==src||src==undefined){
							$(".btn").removeClass("btnok");
							return;
				}else{
...
function setbigimg(){
	for (var i = 0; i < $(".imgfileboxcancel").length; i++) {
		 ...
		 $(".imgfileboxcancel").eq(i).parent(".inputcon").find('label').attr('onclick',"''")
		
		 var src=$(".imgfileboxcancel").eq(i).parent(".inputcon").find('.show_img').attr('src');
		 if(src!='img/addimgicon.png'&&src!='img/zhengmian.png'&&src!='img/fanmian.png'){
	...
	$.showLoading("读取图片");
        ...
        if(files.length){
            ...
            if(!isImage){
               ...
               console.log("处理图片");
               console.log(isImage);
	           console.log((isImage.size/1024/1024).toFixed(2));
	           $.hideLoading();
	           $.showLoading("上传图片...");
            	lrz(isImage,{
            		width: 800
		        ...
		        .then(function (rst) {
					...
					$.showLoading("压缩完成");
					 console.log(rst);
					console.log((rst.base64.length/1024/1024).toFixed(2));
		            console.log(rst.base64Len/1024/1024);
					async(rst.base64,view,v,imgsrc,file,list);
...
//  alert(file.type)
    //使用正则表达式匹配判断
    if(!new RegExp("(jpg|jpeg|png)+","gi").test(file.type)){ 
